-- Unified arbitrage storage schema.
--
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_market_books_sampled
(
    event_ts DateTime64(3, 'UTC'),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_funding_snapshots
(
    event_ts DateTime64(3, 'UTC'),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_opportunities
(
    event_ts DateTime64(3, 'UTC'),
    opportunity_id String,
    ...
    configured_open_spread_bps Float64,
    ...
    expected_net_pnl_usdt Nullable(Float64),
    expected_net_profit_bps Nullable(Float64),
    long_book_age_ms Nullable(Int64),
    short_book_age_ms Nullable(Int64),
    long_top_depth_usdt Float64,
    short_top_depth_usdt Float64,
    executable_top_depth_usdt Float64,
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_signals
(
    event_ts DateTime64(3, 'UTC'),
    signal_id String,
    opportunity_id String,
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_execution_commands
(
    event_ts DateTime64(3, 'UTC'),
    command_id String,
    bundle_id String,
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_order_events
(
    event_ts DateTime64(3, 'UTC'),
    exchange_ts Nullable(DateTime64(3, 'UTC')),
    exchange LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_bundle_events
(
    event_ts DateTime64(3, 'UTC'),
    bundle_id String,
    runtime_mode LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_funding_settlements
(
    event_ts DateTime64(3, 'UTC'),
    bundle_id String,
    exchange LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_reconcile_reports
(
    event_ts DateTime64(3, 'UTC'),
    report_id String,
    runtime_mode LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_route_health_events
(
    event_ts DateTime64(3, 'UTC'),
    exchange LowCardinality(String),
    route LowCardinality(String),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_risk_events
(
    event_ts DateTime64(3, 'UTC'),
...
CREATE TABLE IF NOT EXISTS rustcta.unified_arb_alerts
(
    event_ts DateTime64(3, 'UTC'),
    alert_id String,
    runtime_mode LowCardinality(String),
