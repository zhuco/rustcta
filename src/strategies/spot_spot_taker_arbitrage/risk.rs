...
fn core_trade(trade: &SimulatedTradeRecord) -> CoreSimulatedTradeRecord {
    CoreSimulatedTradeRecord {
        ...
        pnl_category: trade.pnl_category,
        slippage_cost: trade.slippage_cost,
        capital_cost: trade.capital_cost,
        transfer_cost: trade.transfer_cost,
        inventory_rebalance_cost: trade.inventory_rebalance_cost,
        latency_penalty_cost: trade.latency_penalty_cost,
