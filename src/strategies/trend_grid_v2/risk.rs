...
use super::config::TrendGridConfigV2;
...
pub(super) fn build_limits_from_config(config: &TrendGridConfigV2) -> StrategyRiskLimits {
    StrategyRiskLimits {
...
pub(super) async fn evaluate_risk(
...
pub(super) async fn apply_risk_decision(
    config_id: &str,
