...
pub struct ShortLadderMtfGridArgs {
    #[arg(long)]
    pub dataset: PathBuf,
    #[arg(long)]
    pub config: PathBuf,
    ...
    pub order_cooldown_secs: String,
    #[arg(long, default_value = "15,30,45,60")]
    pub min_minutes_to_l4: String,
    #[arg(long, default_value = "1,2,3")]
    pub max_layers_per_hour: String,
    ...
    pub take_profit_specs: String,
    #[arg(long, default_value = "atr")]
    pub layer_price_specs: String,
    #[arg(long, default_value = "legacy")]
    pub entry_signal_specs: String,
    #[arg(long)]
    pub initial_notional_specs: Option<String>,
    #[arg(long)]
    pub layer_weight_specs: Option<String>,
    #[arg(long)]
    pub stop_loss_atr_specs: Option<String>,
    #[arg(long)]
    pub stop_loss_min_layers_specs: Option<String>,
    #[arg(long)]
    pub initial_order_taker_fallback_secs: Option<u64>,
    #[arg(long)]
    pub entry_range_position_specs: Option<String>,
    #[arg(long)]
    pub final_layer_specs: Option<String>,
    #[arg(long)]
    pub skip_json_reports: bool,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ShortLadderMtfGridManifest {
...
pub fn run_short_ladder_mtf_grid(
    args: ShortLadderMtfGridArgs,
) -> Result<ShortLadderMtfGridManifest> {
    ...
    Ok(ShortLadderMtfGridManifest {
        completed_runs: rows.len(),
        summary_path: args.output_dir.join("summary.csv"),
        report_path: args.output_dir.join("report.md"),
    })
}
