...
`docs/exchange_gateway_expansion_30_venues_zh.md`. They are industrial gateway
implementations behind `rustcta_exchange_api::ExchangeClient`; they are not
counted in the legacy `src/exchanges` Spot or `private_perp` percentages until
