...
| public_ws_official_detail_check | 26 |
...
`fmfwio`, `foxbit`, `gemini`, `grvt`, `hashkey_global`, `hibachi`, `hitbtc`, `hollaex`, `krakenfutures`, `kucoinfutures`, `mango_markets`, `mercado`, `myokx`, `ndax`, `novadax`, `okxus`, `onetrading`, `oxfun`, `pacifica`, `tapbit`, `tokocrypto`, `toobit`, `wavesexchange`, `weex`, `xt`, `zaif`
