...
| bsx | perpetual | 2/9 | spec_only/缺推流间隔；缺档位 | 缺推流间隔证据 | 1 | 6 | 108 | 先查官方下单/撤单接口 |
| d8x | perpetual | 2/9 | spec_only/缺推流间隔；缺档位 | 缺推流间隔证据 | 1 | 6 | 108 | 先查官方下单/撤单接口 |
...
| bybiteu | futures,perpetual,spot | 2/9 | spec_only/缺推流间隔 | 缺推流间隔证据 | 0 | 6 | 83 | 先查官方下单/撤单接口 |
