...
mod tests {
    ...
    #[test]
    fn scoring_flags_low_trade_and_weak_profit_factor() {
        ...
        assert!(score.risk_flags.contains(&"low_trade_count".to_string()));
        assert!(score.risk_flags.contains(&"high_drawdown".to_string()));
        assert!(score.risk_flags.contains(&"weak_profit_factor".to_string()));
