...
use super::parser::{
    normalize_depth, normalize_hashkey_global_symbol, parse_orderbook_snapshot, parse_symbol_rules,
};
...
impl HashKeyGlobalGatewayAdapter {
    pub(super) async fn get_symbol_rules_impl(
        ...
        for market_type in markets {
            let endpoint = match market_type {
                ...
                MarketType::Perpetual => "/api/v1/futures/exchangeInfo",
    ...
    pub(super) async fn get_order_book_impl(
        ...
        let endpoint = match request.symbol.market_type {
            ...
            MarketType::Perpetual => "/api/v1/futures/depth",
            _ => unreachable!("checked by ensure_supported_market"),
        };
