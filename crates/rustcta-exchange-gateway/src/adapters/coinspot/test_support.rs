...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("coinspot").expect("coinspot exchange")
}
...
pub(super) fn symbol_scope() -> SymbolScope {
    SymbolScope {
        ...
        canonical_symbol: Some(CanonicalSymbol::new("BTC", "AUD").expect("canonical")),
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Spot, "BTC/AUD")
            .expect("symbol"),
    }
}
