...
pub use config::DeriveChainPerpsGatewayConfig;

#[derive(Clone)]
pub struct DeriveChainPerpsGatewayAdapter {
    exchange_id: ExchangeId,
    config: DeriveChainPerpsGatewayConfig,
}

impl DeriveChainPerpsGatewayAdapter {
    pub fn new(config: DeriveChainPerpsGatewayConfig) -> ExchangeApiResult<Self> {
        Ok(Self {
            exchange_id: ExchangeId::new("derive_chain_perps").map_err(validation_error)?,
            config,
        })
    }
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!(
                    "derive_chain_perps adapter cannot serve request for exchange {exchange}"
                ),
            });
        }
        Ok(())
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Perpetual {
            return Err(ExchangeApiError::Unsupported {
                operation: "derive_chain_perps.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for DeriveChainPerpsGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "derive_chain_perps Derive Chain settlement profile registered as audit-only; use derive adapter for Derive Exchange API runtime"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for DeriveChainPerpsGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        let _ = self.config.read_runtime_available();
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("derive_chain_perps.balances_unverified")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("derive_chain_perps.positions_unverified")
    }
    ...
    async fn get_symbol_rules(
        ...
        self.unsupported("derive_chain_perps.markets_unverified")
    }
    ...
    async fn get_order_book(
        ...
        self.unsupported("derive_chain_perps.order_book_unverified")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("derive_chain_perps.risk_and_fees_unverified")
    }
    ...
    async fn place_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("derive_chain_perps.derive_chain_order_signing_unverified")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("derive_chain_perps.quote_market_order_unsupported")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("derive_chain_perps.cancel_order_signing_unverified")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("derive_chain_perps.amend_order_signing_unverified")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("derive_chain_perps.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("derive_chain_perps.batch_place_order_signing_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("derive_chain_perps.batch_cancel_order_signing_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("derive_chain_perps.cancel_all_orders_signing_unverified")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("derive_chain_perps.query_order_unverified")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("derive_chain_perps.open_orders_unverified")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("derive_chain_perps.recent_fills_unverified")
    }
