    ...
    tokio::spawn(async move {
        loop {
            ...
            let body = responses
                ...
                .unwrap()
                .next()
                .unwrap_or_else(|| json!({ "code": 200, "data": {} }));
...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("bydfi").expect("bydfi exchange")
}
...
pub(super) fn assert_signed_bydfi_request(request: &SeenRequest, method: &str, path: &str) {
