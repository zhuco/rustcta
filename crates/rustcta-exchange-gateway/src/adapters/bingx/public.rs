...
use super::parser::{
    normalize_bingx_symbol, normalize_depth, parse_orderbook_snapshot, parse_symbol_rules,
};
...
impl BingxGatewayAdapter {
    pub(super) async fn get_symbol_rules_impl(
        ...
        for market_type in markets {
            let endpoint = match market_type {
                MarketType::Spot => "/openApi/spot/v1/common/symbols",
                MarketType::Perpetual => "/openApi/swap/v2/quote/contracts",
    ...
    pub(super) async fn get_order_book_impl(
        ...
        let endpoint = match request.symbol.market_type {
            MarketType::Spot => "/openApi/spot/v1/market/depth",
            MarketType::Perpetual => "/openApi/swap/v2/quote/depth",
            _ => unreachable!("checked by ensure_supported_market"),
        };
