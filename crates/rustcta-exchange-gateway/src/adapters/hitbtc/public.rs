...
use super::parser::{normalize_hitbtc_symbol, parse_orderbook_snapshot, parse_symbol_rules};
...
impl HitbtcGatewayAdapter {
    pub(super) async fn get_symbol_rules_impl(
        ...
        let requested_symbols = request
            ...
            .map(|symbol| {
                ...
                normalize_hitbtc_symbol(symbol)
            })
    ...
    pub(super) async fn get_order_book_impl(
        ...
        let symbol = normalize_hitbtc_symbol(&request.symbol)?;
