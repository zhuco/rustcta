...
pub use config::Cod3xGatewayConfig;

#[derive(Clone)]
pub struct Cod3xGatewayAdapter {
    exchange_id: ExchangeId,
    config: Cod3xGatewayConfig,
}

impl Cod3xGatewayAdapter {
    pub fn new(config: Cod3xGatewayConfig) -> ExchangeApiResult<Self> {
        Ok(Self {
            exchange_id: ExchangeId::new("cod3x").map_err(validation_error)?,
            config,
        })
    }
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("cod3x adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Perpetual {
            return Err(ExchangeApiError::Unsupported {
                operation: "cod3x.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for Cod3xGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "cod3x AI perps terminal registered as G0 audit-only; no standalone exchange REST/WS runtime"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for Cod3xGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        let _ = self.config.venue_profiles.len();
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("cod3x.balances_unverified")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("cod3x.positions_unverified")
    }
    ...
    async fn get_symbol_rules(
        ...
        self.unsupported("cod3x.markets_unverified")
    }
    ...
    async fn get_order_book(
        ...
        self.unsupported("cod3x.order_book_unverified")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("cod3x.risk_and_fees_unverified")
    }
    ...
    async fn place_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("cod3x.routed_order_signing_unverified")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("cod3x.quote_market_order_unsupported")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("cod3x.cancel_order_routing_unverified")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("cod3x.amend_order_routing_unverified")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("cod3x.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("cod3x.batch_place_order_routing_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("cod3x.batch_cancel_order_routing_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("cod3x.cancel_all_orders_routing_unverified")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("cod3x.query_order_unverified")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("cod3x.open_orders_unverified")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("cod3x.recent_fills_unverified")
    }
