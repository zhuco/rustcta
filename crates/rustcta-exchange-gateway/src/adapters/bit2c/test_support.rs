...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("bit2c").expect("bit2c exchange")
}
...
pub(super) fn btc_nis_symbol_scope() -> SymbolScope {
    SymbolScope {
        exchange: exchange_id(),
        market_type: MarketType::Spot,
        canonical_symbol: Some(CanonicalSymbol::new("BTC", "NIS").expect("canonical")),
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Spot, "BtcNis")
            .expect("symbol"),
    }
}
