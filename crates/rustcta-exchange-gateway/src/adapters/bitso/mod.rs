...
pub use config::BitsoGatewayConfig;
use transport::BitsoRest;

#[derive(Clone)]
pub struct BitsoGatewayAdapter {
    exchange_id: ExchangeId,
    config: BitsoGatewayConfig,
    rest: BitsoRest,
}

impl BitsoGatewayAdapter {
    pub fn new(config: BitsoGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("bitso").map_err(validation_error)?;
        let rest = BitsoRest::new(
            exchange_id.clone(),
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("bitso adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        parser::ensure_bitso_spot_market(market_type)
    }
...
#[async_trait]
impl GatewayAdapter for BitsoGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "bitso Latin America spot gateway with fiat symbol/request-spec fixtures"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for BitsoGatewayAdapter {
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("bitso.balances_fiat_ledger_read_audit_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitso.spot_positions_unsupported")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("bitso.fees_private_read_not_promoted")
    }
    ...
    async fn place_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("bitso.place_order_offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("bitso.quote_market_order_offline_request_spec_only")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("bitso.cancel_order_offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("bitso.replace_order_not_promoted")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("bitso.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("bitso.batch_place_orders_unsupported")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitso.batch_cancel_orders_unsupported")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitso.cancel_all_orders_private_write_not_promoted")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("bitso.query_order_private_read_not_promoted")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitso.open_orders_private_read_not_promoted")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitso.recent_fills_private_read_not_promoted")
    }
