...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("bitmex").expect("bitmex exchange")
}
...
pub(super) fn spot_symbol_scope() -> SymbolScope {
    SymbolScope {
        ...
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Spot, "XBT_USDT")
            .expect("symbol"),
    }
}
...
pub(super) fn perp_symbol_scope() -> SymbolScope {
    SymbolScope {
        ...
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Perpetual, "XBTUSD")
            .expect("symbol"),
    }
}

pub(super) fn private_config(base_url: String) -> super::BitmexGatewayConfig {
    super::BitmexGatewayConfig {
        rest_base_url: base_url,
        api_key: Some("key".to_string()),
        api_secret: Some("secret".to_string()),
        enabled_private_rest: true,
        ..super::BitmexGatewayConfig::default()
    }
}

pub(super) fn assert_signed_bitmex_request(request: &SeenRequest, method: &str, path: &str) {
