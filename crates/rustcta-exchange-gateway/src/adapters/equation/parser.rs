...
pub const EQUATION_ARBITRUM_CHAIN_ID: u64 = 42_161;

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct EquationAuditBoundary {
    pub chain_id: u64,
...
pub fn parse_equation_audit_boundary(value: &Value) -> ExchangeApiResult<EquationAuditBoundary> {
    Ok(EquationAuditBoundary {
        chain_id: value
            .get("chain_id")
...
pub fn parse_equation_audit_subjects(value: &Value) -> ExchangeApiResult<Vec<String>> {
    let subjects = value
        .get("audit_subjects")
