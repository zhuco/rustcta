    ...
    tokio::spawn(async move {
        loop {
            ...
            let body = responses
                ...
                .unwrap()
                .next()
                .unwrap_or_else(|| json!({ "success": true, "result": {} }));
...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("delta").expect("delta exchange")
}
...
pub(super) fn private_adapter(base_url: String) -> super::DeltaGatewayAdapter {
    super::DeltaGatewayAdapter::new(super::DeltaGatewayConfig {
        rest_base_url: base_url,
        api_key: Some("key".to_string()),
        api_secret: Some("secret".to_string()),
        enabled_private_rest: true,
        ..super::DeltaGatewayConfig::default()
    })
    .expect("adapter")
}
