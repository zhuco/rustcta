...
pub use config::TokocryptoGatewayConfig;
use transport::TokocryptoPublicRest;

#[derive(Clone)]
pub struct TokocryptoGatewayAdapter {
    exchange_id: ExchangeId,
    config: TokocryptoGatewayConfig,
    rest: TokocryptoPublicRest,
}

impl TokocryptoGatewayAdapter {
    pub fn new(config: TokocryptoGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("tokocrypto").map_err(validation_error)?;
        let rest = TokocryptoPublicRest::new(
            exchange_id.clone(),
            config.rest_base_url.clone(),
            config.market_rest_base_url.clone(),
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("tokocrypto adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "tokocrypto.non_spot_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for TokocryptoGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "tokocrypto spot public REST and offline request-spec adapter".to_string(),
            ),
        }
    }
}
...
#[async_trait]
impl ExchangeClient for TokocryptoGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities =
            Some(streams::tokocrypto_private_stream_capabilities(false));
        ...
        capabilities.order_book =
            rustcta_exchange_api::OrderBookCapability::snapshot_only(Some(500));
        capabilities
    }

    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.get_balances.offline_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.positions.unsupported_spot")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("tokocrypto.get_fees.offline_request_spec_only")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("tokocrypto.place_order.offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("tokocrypto.quote_market_order.offline_request_spec_only")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("tokocrypto.cancel_order.offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("tokocrypto.amend_order.unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.unsupported("tokocrypto.order_list.unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.batch_place_orders.unsupported")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.batch_cancel_orders.unsupported")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.cancel_all_orders.unsupported")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("tokocrypto.query_order.offline_request_spec_only")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.get_open_orders.offline_request_spec_only")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("tokocrypto.get_recent_fills.offline_request_spec_only")
    }
