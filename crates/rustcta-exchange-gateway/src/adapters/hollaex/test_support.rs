...
use super::HollaexGatewayConfig;
...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("hollaex").expect("hollaex exchange")
}
...
pub(super) fn symbol_scope() -> SymbolScope {
    SymbolScope {
        ...
        canonical_symbol: Some(CanonicalSymbol::new("XHT", "USDT").expect("canonical")),
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Spot, "xht-usdt")
            .expect("symbol"),
    }
}
