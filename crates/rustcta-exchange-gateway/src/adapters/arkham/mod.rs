...
pub use config::ArkhamGatewayConfig;
use transport::ArkhamPublicRest;

#[derive(Clone)]
pub struct ArkhamGatewayAdapter {
    exchange_id: ExchangeId,
    config: ArkhamGatewayConfig,
    rest: ArkhamPublicRest,
}

impl ArkhamGatewayAdapter {
    pub fn new(config: ArkhamGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("arkham").map_err(validation_error)?;
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("arkham adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if !matches!(market_type, MarketType::Spot | MarketType::Perpetual) {
            return Err(ExchangeApiError::Unsupported {
                operation: "arkham.unsupported_market_type",
            });
        }
        Ok(())
    }
    ...
    fn ensure_public_rest(&self) -> ExchangeApiResult<()> {
        if !self.config.enabled_public_rest {
            return Err(ExchangeApiError::Unsupported {
                operation: "arkham.public_rest_disabled",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for ArkhamGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "arkham spot/perpetual gateway: public REST parser plus private offline specs"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for ArkhamGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities =
            Some(streams::arkham_private_stream_capabilities());
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("arkham.balances_offline_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("arkham.positions_offline_request_spec_only")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("arkham.fees_offline_request_spec_only")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("arkham.place_order_offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("arkham.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("arkham.cancel_order_offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("arkham.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("arkham.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("arkham.batch_place_orders_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("arkham.batch_cancel_orders_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("arkham.cancel_all_orders_offline_request_spec_only")
    }
