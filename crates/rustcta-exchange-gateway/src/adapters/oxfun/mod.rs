...
pub use config::OxfunGatewayConfig;

#[derive(Clone)]
pub struct OxfunGatewayAdapter {
...
impl OxfunGatewayAdapter {
    pub fn new(config: OxfunGatewayConfig) -> ExchangeApiResult<Self> {
        Ok(Self {
            exchange_id: ExchangeId::new("oxfun").map_err(validation_error)?,
            config,
        })
    }
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("oxfun adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if !matches!(market_type, MarketType::Perpetual | MarketType::Option) {
            return Err(ExchangeApiError::Unsupported {
                operation: "oxfun.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for OxfunGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "oxfun perp/options gateway audit shell with request-spec and WS parser fixtures"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for OxfunGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities = Some(if capabilities.supports_private_streams {
            streams::oxfun_private_stream_capabilities()
        } else {
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        private::unsupported_private("oxfun.balances_unverified")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("oxfun.positions_unverified")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        private::unsupported_private("oxfun.fees_unverified")
    }
    ...
    async fn place_order(
        ...
        private::unsupported_private("oxfun.place_order_ws_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("oxfun.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("oxfun.cancel_order_ws_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("oxfun.amend_order_unverified")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        private::unsupported_private("oxfun.order_list_unverified")
    }
    ...
    async fn batch_place_orders(
        ...
        private::unsupported_private("oxfun.batch_place_orders_ws_request_spec_only")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("oxfun.batch_cancel_orders_ws_request_spec_only")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("oxfun.cancel_all_orders_unverified")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("oxfun.query_order_unverified")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("oxfun.open_orders_unverified")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("oxfun.recent_fills_unverified")
    }
