...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("krakenfutures").expect("krakenfutures exchange")
}
...
pub(super) fn private_config(base_url: String) -> super::KrakenFuturesGatewayConfig {
    super::KrakenFuturesGatewayConfig {
        ...
        ..super::KrakenFuturesGatewayConfig::default()
    }
}
