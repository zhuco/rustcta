...
pub use config::PacificaGatewayConfig;

#[derive(Clone)]
pub struct PacificaGatewayAdapter {
...
impl PacificaGatewayAdapter {
    pub fn new(config: PacificaGatewayConfig) -> ExchangeApiResult<Self> {
        Ok(Self {
            exchange_id: ExchangeId::new("pacifica").map_err(validation_error)?,
            config,
        })
    }
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("pacifica adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if !matches!(market_type, MarketType::Perpetual) {
            return Err(ExchangeApiError::Unsupported {
                operation: "pacifica.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for PacificaGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "pacifica perpetual gateway adapter with public REST and offline signing specs"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for PacificaGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities = Some(if capabilities.supports_private_streams {
            streams::pacifica_private_stream_capabilities()
        } else {
        ...
        capabilities.order_book =
            rustcta_exchange_api::OrderBookCapability::snapshot_only(Some(10));
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        private::unsupported_private("pacifica.balances_account_info_not_mapped")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("pacifica.positions_request_spec_only")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        private::unsupported_private("pacifica.fees_account_info_not_mapped")
    }
    ...
    async fn place_order(
        ...
        private::unsupported_private("pacifica.place_order_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("pacifica.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("pacifica.cancel_order_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("pacifica.amend_order_request_spec_only")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        private::unsupported_private("pacifica.order_list_unverified")
    }
    ...
    async fn batch_place_orders(
        ...
        private::unsupported_private("pacifica.batch_orders_request_spec_only")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("pacifica.batch_cancel_orders_request_spec_only")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("pacifica.cancel_all_orders_request_spec_only")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::unsupported_private("pacifica.query_order_request_spec_only")
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("pacifica.open_orders_request_spec_only")
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::unsupported_private("pacifica.recent_fills_request_spec_only")
    }
