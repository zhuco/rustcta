...
pub use config::ZaifGatewayConfig;
use transport::ZaifRest;

#[derive(Clone)]
pub struct ZaifGatewayAdapter {
    exchange_id: ExchangeId,
    config: ZaifGatewayConfig,
    rest: ZaifRest,
}

impl ZaifGatewayAdapter {
    pub fn new(config: ZaifGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("zaif").map_err(validation_error)?;
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("zaif adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "zaif.non_spot_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for ZaifGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some("zaif spot REST adapter".to_string()),
        }
    }
}

#[async_trait]
impl ExchangeClient for ZaifGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities = Some(streams::zaif_private_stream_capabilities(
            self.config.enabled_private_streams,
        ));
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("zaif.get_balances.offline_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("zaif.positions.unsupported_spot")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("zaif.get_fees.unsupported")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("zaif.place_order.offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("zaif.quote_market_order.unsupported")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("zaif.cancel_order.offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("zaif.amend_order.unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.unsupported("zaif.order_list.unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("zaif.batch_place_orders.unsupported")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("zaif.batch_cancel_orders.unsupported")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("zaif.cancel_all_orders.unsupported")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.unsupported("zaif.query_order.offline_request_spec_only")
    }
