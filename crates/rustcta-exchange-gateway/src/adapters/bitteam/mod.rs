...
pub use config::BitteamGatewayConfig;
use transport::BitteamRest;

#[derive(Clone)]
pub struct BitteamGatewayAdapter {
    exchange_id: ExchangeId,
    config: BitteamGatewayConfig,
    rest: BitteamRest,
}

impl BitteamGatewayAdapter {
    pub fn new(config: BitteamGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("bitteam").map_err(validation_error)?;
        let rest = BitteamRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(BitteamGatewayConfig::default())
    }

    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("bitteam adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "bitteam.non_spot_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for BitteamGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "bitteam spot scan-only public REST gateway; private REST request-spec-only"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for BitteamGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities =
            Some(streams::bitteam_private_stream_capabilities());
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("bitteam.balances_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("bitteam.positions_unsupported_spot_only")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("bitteam.fees_unverified")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("bitteam.place_order_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("bitteam.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("bitteam.cancel_order_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("bitteam.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_spot(request.symbol().market_type)?;
        self.unsupported("bitteam.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("bitteam.batch_place_orders_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.unsupported("bitteam.batch_cancel_orders_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.unsupported("bitteam.cancel_all_orders_request_spec_only")
    }
