...
pub use config::BinanceCoinMGatewayConfig;
use transport::BinanceCoinMRest;

#[derive(Clone)]
pub struct BinanceCoinMGatewayAdapter {
    exchange_id: ExchangeId,
    config: BinanceCoinMGatewayConfig,
    rest: BinanceCoinMRest,
}

impl BinanceCoinMGatewayAdapter {
    pub fn new(config: BinanceCoinMGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("binancecoinm").map_err(validation_error)?;
        let rest = BinanceCoinMRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(BinanceCoinMGatewayConfig::default())
    }
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!(
                    "binancecoinm adapter cannot serve request for exchange {exchange}"
                ),
            });
        }
        Ok(())
    ...
    fn ensure_coin_m(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if !matches!(market_type, MarketType::Futures | MarketType::Perpetual) {
            return Err(ExchangeApiError::Unsupported {
                operation: "binancecoinm.non_coin_m_market_type",
            });
        }
        Ok(())
    }
        ...
        let tenant_id =
            context
                ...
                .ok_or_else(|| ExchangeApiError::InvalidRequest {
                    message: "binancecoinm private REST readback requires context.tenant_id"
                        .to_string(),
                })?;
        let account_id =
            context
                ...
                .clone()
                .ok_or_else(|| ExchangeApiError::InvalidRequest {
                    message: "binancecoinm private REST readback requires context.account_id"
                        .to_string(),
                })?;
...
#[async_trait]
impl GatewayAdapter for BinanceCoinMGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some("binancecoinm COIN-M public REST gateway adapter".to_string()),
        }
    }
}

#[async_trait]
impl ExchangeClient for BinanceCoinMGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.market_types = vec![MarketType::Futures, MarketType::Perpetual];
    ...
    async fn place_quote_market_order(
        ...
        self.unsupported_private("binancecoinm.place_quote_market_order")
    }
    ...
    async fn place_order_list(
        ...
        self.unsupported_private("binancecoinm.place_order_list")
    }
    ...
    async fn subscribe_public_stream(
        ...
        Err(ExchangeApiError::Unsupported {
            operation: "binancecoinm.subscribe_public_stream",
        })
    }
    ...
    async fn subscribe_private_stream(
        ...
        self.unsupported_private("binancecoinm.subscribe_private_stream")
    }
}
