...
pub use config::P2bGatewayConfig;
use transport::P2bRest;

#[derive(Clone)]
pub struct P2bGatewayAdapter {
    exchange_id: ExchangeId,
    config: P2bGatewayConfig,
    rest: P2bRest,
}

impl P2bGatewayAdapter {
    pub fn new(config: P2bGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("p2b").map_err(validation_error)?;
        let rest = P2bRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(P2bGatewayConfig::default())
    }

    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("p2b adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "p2b.non_spot_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for P2bGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "p2b spot scan-only public REST gateway; private REST request-spec-only"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for P2bGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities = Some(streams::p2b_private_stream_capabilities());
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("p2b.balances_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("p2b.positions_unsupported_spot_only")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("p2b.fees_unverified")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("p2b.place_order_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("p2b.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("p2b.cancel_order_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("p2b.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_spot(request.symbol().market_type)?;
        self.unsupported("p2b.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("p2b.batch_place_orders_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.unsupported("p2b.batch_cancel_orders_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.unsupported("p2b.cancel_all_orders_request_spec_only")
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("p2b.query_order_request_spec_only")
    }
    ...
    async fn get_open_orders(
        ...
        self.unsupported("p2b.open_orders_request_spec_only")
    }
    ...
    async fn get_recent_fills(
        ...
        self.unsupported("p2b.recent_fills_request_spec_only")
    }
