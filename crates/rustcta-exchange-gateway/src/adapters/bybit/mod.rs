...
pub use config::BybitGatewayConfig;
use transport::BybitRest;

#[derive(Clone)]
pub struct BybitGatewayAdapter {
    exchange_id: ExchangeId,
    config: BybitGatewayConfig,
    rest: BybitRest,
}
...
impl BybitGatewayAdapter {
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(BybitGatewayConfig::default())
    }
...
#[async_trait]
impl GatewayAdapter for BybitGatewayAdapter {
...
#[async_trait]
impl ExchangeClient for BybitGatewayAdapter {
