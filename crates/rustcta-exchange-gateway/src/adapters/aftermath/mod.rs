...
pub use config::AftermathGatewayConfig;
use transport::AftermathRest;

#[derive(Clone)]
pub struct AftermathGatewayAdapter {
    exchange_id: ExchangeId,
    config: AftermathGatewayConfig,
    rest: AftermathRest,
}

impl AftermathGatewayAdapter {
    pub fn new(config: AftermathGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("aftermath").map_err(validation_error)?;
        let rest = AftermathRest::new(
            exchange_id.clone(),
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("aftermath adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Perpetual {
            return Err(ExchangeApiError::Unsupported {
                operation: "aftermath.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for AftermathGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "aftermath perpetual public REST scan-only; Sui transaction writes unsupported"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for AftermathGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        if !self.config.enabled_public_rest {
            capabilities.capabilities_v2.public_rest =
                CapabilitySupport::unsupported("aftermath public REST disabled by config");
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        private::sui_transaction_unsupported(private::BALANCES_UNSUPPORTED)
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::sui_transaction_unsupported(private::POSITIONS_UNSUPPORTED)
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        private::sui_transaction_unsupported(private::FEES_UNSUPPORTED)
    }
    ...
    async fn place_order(
        ...
        private::sui_transaction_unsupported(private::PLACE_ORDER_UNSUPPORTED)
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::sui_transaction_unsupported(private::CANCEL_ORDER_UNSUPPORTED)
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::sui_transaction_unsupported(private::AMEND_ORDER_UNSUPPORTED)
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        private::sui_transaction_unsupported(private::ORDER_LIST_UNSUPPORTED)
    }
    ...
    async fn batch_place_orders(
        ...
        private::sui_transaction_unsupported(private::BATCH_PLACE_UNSUPPORTED)
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::sui_transaction_unsupported(private::BATCH_CANCEL_UNSUPPORTED)
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::sui_transaction_unsupported(private::CANCEL_ALL_UNSUPPORTED)
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::sui_transaction_unsupported(private::QUERY_ORDER_UNSUPPORTED)
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::sui_transaction_unsupported(private::OPEN_ORDERS_UNSUPPORTED)
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::sui_transaction_unsupported(private::RECENT_FILLS_UNSUPPORTED)
    }
