...
pub use config::MercadoGatewayConfig;
use transport::MercadoRest;

#[derive(Clone)]
pub struct MercadoGatewayAdapter {
    exchange_id: ExchangeId,
    config: MercadoGatewayConfig,
    rest: MercadoRest,
}

impl MercadoGatewayAdapter {
    pub fn new(config: MercadoGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("mercado").map_err(validation_error)?;
        let rest = MercadoRest::new(
            exchange_id.clone(),
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("mercado adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        parser::ensure_mercado_spot_market(market_type)
    }
...
#[async_trait]
impl GatewayAdapter for MercadoGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "mercado bitcoin Brazil/Latin America spot gateway with BRL request-spec fixtures"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for MercadoGatewayAdapter {
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("mercado.balances_fiat_ledger_read_audit_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("mercado.spot_positions_unsupported")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("mercado.fees_private_read_not_promoted")
    }
    ...
    async fn place_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("mercado.place_order_offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("mercado.quote_market_order_offline_request_spec_only")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("mercado.cancel_order_offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("mercado.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("mercado.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("mercado.batch_place_orders_unsupported")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("mercado.batch_cancel_orders_unsupported")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("mercado.cancel_all_orders_offline_request_spec_only")
    }
