...
impl CexGatewayAdapter {
    ...
    pub(super) fn query_order_unsupported(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("cex.query_order_private_rest_deferred")
    }
    ...
    pub(super) fn get_open_orders_unsupported(
        ...
        self.unsupported("cex.open_orders_private_rest_deferred")
    }
    ...
    pub(super) fn get_recent_fills_unsupported(
        ...
        self.unsupported("cex.recent_fills_private_rest_deferred")
    }
}
