...
pub fn parse_order_state(
    ...
    Ok(OrderState {
        ...
        status: value
            ...
            .or_else(|| value.get("X"))
            .and_then(Value::as_str)
            .map(map_binanceus_order_status)
...
pub fn parse_binanceus_cancel_all_orders(
    exchange_id: &ExchangeId,
    ...
    let canonical_symbol =
        symbol
            ...
            .ok_or_else(|| ExchangeApiError::InvalidRequest {
                message: "binanceus recent fills request requires canonical_symbol".to_string(),
            })?;
...
fn parse_fee_snapshot(
    ...
    Ok(FeeRateSnapshot {
        ...
        maker_rate: maker,
        taker_rate: taker,
        source: Some("binanceus.trading_fee".to_string()),
        updated_at: Utc::now(),
    })
}

fn map_binanceus_order_status(status: &str) -> OrderStatus {
