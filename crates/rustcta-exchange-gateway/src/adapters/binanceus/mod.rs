...
pub use config::BinanceUsGatewayConfig;
use transport::BinanceUsPublicRest;

#[derive(Clone)]
pub struct BinanceUsGatewayAdapter {
    exchange_id: ExchangeId,
    config: BinanceUsGatewayConfig,
    rest: BinanceUsPublicRest,
}

impl BinanceUsGatewayAdapter {
    pub fn new(config: BinanceUsGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("binanceus").map_err(validation_error)?;
        let rest = BinanceUsPublicRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(BinanceUsGatewayConfig::default())
    }

    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("binanceus adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "binanceus.non_spot_market_type",
            });
        }
        Ok(())
    }
        ...
        let tenant_id =
            context
                ...
                .ok_or_else(|| ExchangeApiError::InvalidRequest {
                    message: "binanceus private REST readback requires context.tenant_id"
                        .to_string(),
                })?;
        let account_id =
            context
                ...
                .clone()
                .ok_or_else(|| ExchangeApiError::InvalidRequest {
                    message: "binanceus private REST readback requires context.account_id"
                        .to_string(),
                })?;
...
#[async_trait]
impl GatewayAdapter for BinanceUsGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some("binanceus spot public REST gateway adapter".to_string()),
        }
    }
}

#[async_trait]
impl ExchangeClient for BinanceUsGatewayAdapter {
    ...
    async fn get_positions(
        ...
        self.unsupported_private("binanceus.get_positions")
    }
    ...
    async fn amend_order(
        ...
        self.unsupported_private("binanceus.amend_order_unmapped")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_spot(request.symbol().market_type)?;
        self.unsupported_private("binanceus.place_order_list_unmapped")
    }
    ...
    async fn subscribe_public_stream(
        ...
        Err(ExchangeApiError::Unsupported {
            operation: "binanceus.subscribe_public_stream",
        })
    }
    ...
    async fn subscribe_private_stream(
        ...
        self.unsupported_private("binanceus.subscribe_private_stream")
    }
}
