...
pub use config::FoxbitGatewayConfig;
use transport::FoxbitRest;

#[derive(Clone)]
pub struct FoxbitGatewayAdapter {
    exchange_id: ExchangeId,
    config: FoxbitGatewayConfig,
    rest: FoxbitRest,
}

impl FoxbitGatewayAdapter {
    pub fn new(config: FoxbitGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("foxbit").map_err(validation_error)?;
        let rest = FoxbitRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(FoxbitGatewayConfig::default())
    }

    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("foxbit adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        parser::ensure_foxbit_spot_market(market_type)
    }
...
#[async_trait]
impl GatewayAdapter for FoxbitGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "foxbit Brazil spot gateway with REST v3 public data and offline private specs"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for FoxbitGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.max_order_book_depth = Some(300);
        capabilities.order_book =
            rustcta_exchange_api::OrderBookCapability::snapshot_only(Some(300));
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("foxbit.balances_private_read_offline_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("foxbit.spot_positions_unsupported")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("foxbit.fees_private_read_not_promoted")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("foxbit.place_order_offline_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("foxbit.quote_market_order_offline_request_spec_only")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("foxbit.cancel_order_offline_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        self.unsupported("foxbit.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        self.unsupported("foxbit.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("foxbit.batch_place_orders_unsupported")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("foxbit.batch_cancel_orders_unsupported")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.unsupported("foxbit.cancel_all_orders_unsupported")
    }
