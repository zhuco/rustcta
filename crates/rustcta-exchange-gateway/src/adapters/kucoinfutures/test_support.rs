...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("kucoinfutures").expect("kucoinfutures exchange")
}
...
pub(super) fn symbol_scope() -> SymbolScope {
    SymbolScope {
        ...
        canonical_symbol: Some(CanonicalSymbol::new("XBT", "USDT").expect("canonical")),
        exchange_symbol: ExchangeSymbol::new(exchange_id(), MarketType::Perpetual, "XBTUSDTM")
            .expect("symbol"),
    }
}
