...
use super::parser::{
    normalize_depth, normalize_weex_symbol, parse_orderbook_snapshot, parse_symbol_rules,
};
...
impl WeexGatewayAdapter {
    pub(super) async fn get_symbol_rules_impl(
        ...
        for market_type in markets {
            let endpoint = match market_type {
                ...
                MarketType::Perpetual => "/capi/v3/market/exchangeInfo",
    ...
    pub(super) async fn get_order_book_impl(
        ...
        let endpoint = match request.symbol.market_type {
            MarketType::Spot => "/api/v3/market/depth",
            MarketType::Perpetual => "/capi/v3/market/depth",
            _ => unreachable!("checked by ensure_supported_market"),
        };
