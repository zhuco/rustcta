...
pub(super) fn exchange_id() -> ExchangeId {
    ExchangeId::new("toobit").expect("toobit exchange")
}
...
pub(super) fn spot_symbol_scope() -> SymbolScope {
    symbol_scope(MarketType::Spot, "BTCUSDT")
}

pub(super) fn perp_symbol_scope() -> SymbolScope {
    symbol_scope(MarketType::Perpetual, "BTC-SWAP-USDT")
}
...
pub(super) fn assert_signed_toobit_request(request: &SeenRequest, method: &str, path: &str) {
