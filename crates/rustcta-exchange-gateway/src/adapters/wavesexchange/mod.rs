...
pub use config::WavesExchangeGatewayConfig;
use transport::WavesExchangeRest;

#[derive(Clone)]
pub struct WavesExchangeGatewayAdapter {
    exchange_id: ExchangeId,
    config: WavesExchangeGatewayConfig,
    rest: WavesExchangeRest,
}

impl WavesExchangeGatewayAdapter {
    pub fn new(config: WavesExchangeGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("wavesexchange").map_err(validation_error)?;
        let rest = WavesExchangeRest::new(
            exchange_id.clone(),
    ...
    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!(
                    "wavesexchange adapter cannot serve request for exchange {exchange}"
                ),
            });
        }
        Ok(())
    ...
    fn ensure_supported_market_type(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "wavesexchange.unsupported_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for WavesExchangeGatewayAdapter {
    fn gateway_exchange_status(&self) -> GatewayExchangeStatus {
        GatewayExchangeStatus {
            ...
            message: Some(
                "wavesexchange spot matcher public REST scan-only; Waves order signing writes unsupported"
                    .to_string(),
            ),
        }
    }
...
#[async_trait]
impl ExchangeClient for WavesExchangeGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        if !self.config.enabled_public_rest {
            capabilities.capabilities_v2.public_rest =
                CapabilitySupport::unsupported("wavesexchange public REST disabled by config");
            for endpoint in &mut capabilities.capabilities_v2.endpoints {
                if endpoint.operation == "get_symbol_rules"
                    || endpoint.operation == "get_order_book"
                {
                    endpoint.support = CapabilitySupport::unsupported(
                        "wavesexchange public REST disabled by config",
                    );
                }
            }
        }
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        private::waves_unsupported(private::BALANCES_UNSUPPORTED)
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::waves_unsupported(private::POSITIONS_UNSUPPORTED)
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        private::waves_unsupported(private::FEES_UNSUPPORTED)
    }
    ...
    async fn place_order(
        ...
        private::waves_unsupported(private::PLACE_ORDER_UNSUPPORTED)
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::waves_unsupported(private::CANCEL_ORDER_UNSUPPORTED)
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::waves_unsupported(private::AMEND_ORDER_UNSUPPORTED)
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_supported_market_type(request.symbol().market_type)?;
        private::waves_unsupported(private::ORDER_LIST_UNSUPPORTED)
    }
    ...
    async fn batch_place_orders(
        ...
        private::waves_unsupported(private::BATCH_PLACE_UNSUPPORTED)
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::waves_unsupported(private::BATCH_CANCEL_UNSUPPORTED)
    }
    ...
    async fn cancel_all_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::waves_unsupported(private::CANCEL_ALL_UNSUPPORTED)
    }
    ...
    async fn query_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_supported_market_type(request.symbol.market_type)?;
        private::waves_unsupported(private::QUERY_ORDER_UNSUPPORTED)
    }
    ...
    async fn get_open_orders(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::waves_unsupported(private::OPEN_ORDERS_UNSUPPORTED)
    }
    ...
    async fn get_recent_fills(
        ...
        self.ensure_exchange(&request.exchange)?;
        private::waves_unsupported(private::RECENT_FILLS_UNSUPPORTED)
    }
