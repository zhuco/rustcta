...
pub use config::YobitGatewayConfig;
use transport::YobitRest;

#[derive(Clone)]
pub struct YobitGatewayAdapter {
    exchange_id: ExchangeId,
    config: YobitGatewayConfig,
    rest: YobitRest,
}

impl YobitGatewayAdapter {
    pub fn new(config: YobitGatewayConfig) -> ExchangeApiResult<Self> {
        let exchange_id = ExchangeId::new("yobit").map_err(validation_error)?;
        let rest = YobitRest::new(
            exchange_id.clone(),
    ...
    pub fn default_public() -> ExchangeApiResult<Self> {
        Self::new(YobitGatewayConfig::default())
    }

    fn ensure_exchange(&self, exchange: &ExchangeId) -> ExchangeApiResult<()> {
        if exchange != &self.exchange_id {
            return Err(ExchangeApiError::InvalidRequest {
                message: format!("yobit adapter cannot serve request for exchange {exchange}"),
            });
        }
        Ok(())
    }
    ...
    fn ensure_spot(&self, market_type: MarketType) -> ExchangeApiResult<()> {
        if market_type != MarketType::Spot {
            return Err(ExchangeApiError::Unsupported {
                operation: "yobit.non_spot_market_type",
            });
        }
        Ok(())
    }
...
#[async_trait]
impl GatewayAdapter for YobitGatewayAdapter {
...
#[async_trait]
impl ExchangeClient for YobitGatewayAdapter {
    ...
    fn capabilities(&self) -> ExchangeClientCapabilities {
        ...
        capabilities.private_stream_capabilities =
            Some(streams::yobit_private_stream_capabilities());
        ...
        capabilities.max_order_book_depth = Some(2000);
        capabilities.order_book =
            rustcta_exchange_api::OrderBookCapability::snapshot_only(Some(2000));
    ...
    async fn get_balances(&self, request: BalancesRequest) -> ExchangeApiResult<BalancesResponse> {
        ...
        self.unsupported("yobit.balances_request_spec_only")
    }
    ...
    async fn get_positions(
        ...
        self.ensure_exchange(&request.exchange)?;
        self.unsupported("yobit.positions_unsupported_spot_only")
    }
    ...
    async fn get_fees(&self, request: FeesRequest) -> ExchangeApiResult<FeesResponse> {
        ...
        self.unsupported("yobit.fees_unverified")
    }
    ...
    async fn place_order(
        ...
        self.unsupported("yobit.place_order_request_spec_only")
    }
    ...
    async fn place_quote_market_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("yobit.quote_market_order_unverified")
    }
    ...
    async fn cancel_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("yobit.cancel_order_request_spec_only")
    }
    ...
    async fn amend_order(
        ...
        self.ensure_exchange(&request.symbol.exchange)?;
        self.ensure_spot(request.symbol.market_type)?;
        self.unsupported("yobit.amend_order_unsupported")
    }
    ...
    async fn place_order_list(
        ...
        self.ensure_exchange(&request.symbol().exchange)?;
        self.ensure_spot(request.symbol().market_type)?;
        self.unsupported("yobit.order_list_unsupported")
    }
    ...
    async fn batch_place_orders(
        ...
        self.unsupported("yobit.batch_place_orders_unverified")
    }
    ...
    async fn batch_cancel_orders(
        ...
        self.unsupported("yobit.batch_cancel_orders_unverified")
    }
    ...
    async fn cancel_all_orders(
        ...
        self.unsupported("yobit.cancel_all_orders_request_spec_only")
    }
